...
const DEFAULT_STOCK = Number(process.env.DEFAULT_STOCK || 999999); // evita zerar estoque
...
// Health
app.get("/", (req, res) => res.json({ ok: true, name: SERVICE_NAME, uptime: process.uptime() }));

// 1) CHECK STOCK -> SEMPRE manda estoque alto (o Ease não zera)
...
// 2) GET STOCK -> pagamento aprovado (não mexe em estoque)
